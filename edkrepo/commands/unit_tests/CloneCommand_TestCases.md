...
### `__init__` (inherited from `BaseTestCloneCommand`)
...
### `get_metadata` (inherited from `BaseTestCloneCommand`)
...
### `_resolve_reference_settings` (inherited from `BaseTestCloneCommand`)
